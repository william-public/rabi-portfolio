...
const projects = [
  {
    id: 1,
    title: "Thrive Canada Mobile App",
    description: "A secure, performance-optimized Android application for healthcare and wellness engagement. Built with scalability and reliability in mind, the app integrates API-driven content, mobile UX best practices, and secure data handling to support real-world healthcare use cases.",
    image: "/thrivecanada-app.png",
    category: "mobile",
    technologies: ["Flutter", "iOS", "REST APIs", "Security & Compliance", "Analytics"],
    demoUrl: "https://play.google.com/store/apps/details?id=com.cgi.mhp.thrivecanada&hl=en",
  },
  {
    id: 2,
    title: "Hotels Canada Mobile App",
    description: "A consumer-facing mobile application designed to help users discover and book hotels across Canada. The app focuses on performance, intuitive navigation, and a streamlined search experience, enabling users to find accommodations quickly and efficiently on mobile devices.",
    image: "/hotelscanada-app.png",
    category: "mobile",
    technologies: ["React Native", "Android SDK", "REST APIs", "Google Play Services"],
    demoUrl: "https://play.google.com/store/apps/details?id=com.turnedomarketing.hotelscanada&hl=en",
    featured: false,
  },
  {
    id: 3,
    title: "Perfume Factory",
    description: "A sleek, e-commerce focused website for a fragrance retailer. The platform emphasizes product discovery, intuitive navigation, and a seamless shopping experience while showcasing the brand’s aesthetic through immersive visuals and responsive design.",
    image: "/perfumefactory.png",
    category: "web",
    technologies: ["PHP", "Shopify", "Stripe", "Shopify/Commerce Integration", "SEO Optimization"],
    demoUrl: "https://perfumefactory.ca/",
  },
  {
    id: 4,
    title: "Beekeeper’s Naturals",
    description: "A modern, conversion-focused e-commerce platform for a premium natural wellness brand. The site emphasizes clean design, educational storytelling, and trust-building content while delivering a fast, fully responsive shopping experience optimized for health-conscious consumers.",
    image: "/beekeepersnaturals.png",
    category: "web",
    technologies: ["PHP", "Shopify", "Shopify", "REST APIs", "HSTS"],
    demoUrl: "https://www.beekeepersnaturals.com/",
    featured: true,
  },
  {
    id: 5,
    title: "Michener Institute",
    description: "A professional, education-focused website for a leading healthcare training institute. The platform emphasizes clear program information, intuitive navigation, and accessibility compliance, providing students and professionals with a seamless user experience across devices.",
    image: "/michener.png",
    category: "web",
    technologies: ["React", "Next.js", "Tailwind CSS", "Accessibility Standards (WCAG)", "SEO Optimization"],
    demoUrl: "https://michener.ca/",
  },
  {
    id: 6,
    title: "Halifax Taxi",
    description: "A responsive, performance-optimized service platform for a local taxi provider. Built with a mobile-first approach, the site integrates location services, conversion-focused UX, and local SEO strategies to drive bookings and improve customer accessibility across devices.",
    image: "/halifaxtaxi.png",
    category: "web",
    technologies: ["PHP", "CI", "Bootstrap", "Google Maps API", "Schema Markup"],
    demoUrl: "https://halifaxtaxi.ca/",
  },
  {
    id: 7,
    title: "World Weight Loss Inc",
    description: "A professional, health-focused service website for a weight loss clinic. The platform emphasizes user-friendly navigation, clear program information, and trust-building design elements to attract and convert potential clients while providing a responsive experience across all devices.",
    image: "/worldweightlossinc.png",
    category: "web",
    technologies: ["PHP", "WordPress", "Google Map", "SEO Optimization", "Contact Form Integration"],
    demoUrl: "https://worldweightlossinc.ca/",
  },
  {
    id: 8,
    title: "Tachara",
    description: "A refined, brand-focused website for a premium jewelry and lifestyle retailer. The platform emphasizes elegant visual presentation, product storytelling, and a smooth browsing experience, delivering a fully responsive interface optimized for customer engagement.",
    image: "/tachara.png",
    category: "web",
    technologies: ["React", "Next.js", "Tailwind CSS", "E-commerce Integration", "SEO Optimization"],
    demoUrl: "https://tachara.ca/",
    featured: false,
  },
  {
    id: 9,
    title: "Capital Roofing",
    description: "A conversion-focused service website for a professional roofing company. The platform highlights services, project credibility, and clear call-to-actions, providing homeowners with an intuitive, mobile-friendly experience optimized for lead generation.",
    image: "/capitalroofing.png",
    category: "web",
    technologies: ["Vue", "Nuxt.js", "Laravel", "Lead Form Integration", "Local SEO"],
    demoUrl: "https://capitalroofing.ca/",
  }
]
